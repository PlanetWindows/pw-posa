const CACHE_NAME = 'pw-posa-shell-v10';
...
const APP_SHELL = [
  ...
  './hotfix.css',
  './assistance.css',
  './assistance-save-archive-calendar-fix.css',
  './assistance.js',
  './assistance-validation-fix.js',
  './assistance-team-fix.js',
  './assistance-auto-report.js',
  './assistance-save-archive-calendar-fix.js',
  './logo_planet.svg',
  './app-icon.svg',
  './icon-192-v2.png',
  './icon-512-v2.png',
